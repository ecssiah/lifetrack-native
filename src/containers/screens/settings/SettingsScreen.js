...
import { updateSettings, updateSettingsLocal } from '../../../handlers/SettingsHandlers'
...
class SettingsScreen extends React.Component 
{
  ...
  _onSettingConfirm = () => {
    ...
    this.props.updateSettingsLocal(update)
...
const mapDispatchToProps = dispatch => ({
  ...
  updateSettingsLocal: update => updateSettingsLocal(update),
})
