          ...
          <View style={styles.introSection} >
            ...
            <View style={styles.introBody} >
              <LTText>
                ...
                technique by allowing the user to track their longterm progress
                towards a series focuses.
              </LTText>
              ...
              <LTText>
                ...
                The Work Period is the length of each work session before a 
                break occurs, and the Break Period allows the user to set the 
          ...
          <View style={styles.focusesSection}>
            ...
            <View style={styles.focusesBody}>
              ...
              <LTText>
                ...
                Each category name can be pressed to hide its focuses. Pressing 
                any of the focuses will take the user to the Focus Screen. It
                can also be found by clicking on the target icon in the middle
